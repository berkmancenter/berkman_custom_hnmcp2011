...
?>
		...
		<?php while (have_posts()) : the_post(); ?>
			...
			<?php the_content(); ?>
            <p class="back_to_TOC"><a href="<?php network_home_url(); ?>/issues/<?php echo $displayNewsletterSlug ?>">&laquo; back to the <?php echo $displayNewsletter; ?> Table of Contents</a></p>
		<?php endwhile; ?>
